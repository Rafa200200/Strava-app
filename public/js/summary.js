...
function updateStats(visitedCities, geojson) {
    ...
    document.getElementById('concelhos-percent').innerHTML = `Porcentagem de Concelhos Visitados: <strong>${visitedPercent}%</strong>`;
    ...
    document.getElementById('distritos-percent').innerHTML = `Porcentagem de Distritos Completos: <strong>${completeDistrictsPercent}%</strong>`;
